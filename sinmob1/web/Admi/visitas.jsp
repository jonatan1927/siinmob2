         ...
         HttpSession miSesion = request.getSession(false);
            if(miSesion.getAttribute("usuario")==null){
              ...
              HttpSession hs = request.getSession(true);
                ArrayList<citaDTO> t=(ArrayList<citaDTO>) hs.getAttribute("cita"); 
                %> 
            ...
            <ul>
                ...
                <li><a href="#"><img src="../imagenes/PNG/credit-card.png"/>Visitas</a> </li>
...
<tr >
   ...
   <% 
                 ...
                 <tr style="background-color:#ffffff"><td> <%=t.get(I).getDir() %></td>
                 <td><%=t.get(I).getNom() %></td>
                 <td><%if(t.get(I).getInteres()==1){
                       out.print("interesado"); }
                 else {
                 out.print("no esta interesado");}%></td>
                 <td><%=t.get(I).getFechaVisita() %></td>               
         <%   }}
                 %>
    </tr></tbody>
  </table>
