...
%>
       ...
       <style type="text/css">
         ...
         HttpSession miSesion = request.getSession(false);
            ...
            <ul>
                ...
                <li><a href="#"><img src="../imagenes/PNG/add-user.png"/>Usuarios</a> </li>
  ...
  <a href="excel.jsp">Generar excel</a>
  </form>            
                    </div><br><br><br>
    ...
    <tbody>
       <% 
                 ...
                 <td><a href=../Eusuario?cod=<%=t.get(I).getId()%>>
                         <img src='../imagenes/PNG/circle-with-cross.png' align='middle' width='32' height='32'/></a></td>
         <%   }}
                 %>
    </tr></tbody>
  </table>
