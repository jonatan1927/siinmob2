 ...
 * @author jonatan
 */
public class ClienteDTO extends UsuariosDTO {
    ...
    public ClienteDTO(int cedula, String pNombre, String sNombre, String pApellido, String sApellido, String direccion, String genero, String email, String fecha, int cedulauno) {
